...
.factory('autentificFactory', ['$http', '$timeout', '$cookies', 'Upload', '$rootScope',  function($http, $timeout, $cookies, Upload, $rootScope) {
	'use strict';
	console.log('autent factory')
	return {
